...
#include "com_example_loader_Loader.h"
...
JNIEXPORT jstring JNICALL Java_com_example_loader_Loader_sayHello(JNIEnv * env, jobject self, jstring name_from_java) {
